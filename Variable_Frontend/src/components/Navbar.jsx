      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="buttons text-center">
            {user ? (
              ...
              <NavLink to="/register" className="btn btn-outline-light m-2">
                <PersonAddOutlinedIcon
                  style={{ fontSize: "20px", paddingBottom: "3.5px" }}
                />
                Register
              </NavLink>
            )}
            ...
            {user?.role === Role.ADMIN ? (
              <span>
                <NavLink to="/users" className="btn btn-outline-light m-2">
                ...
                >
                  <i className="fa fa-solid fa-plus"></i>Add Category
                </NavLink>
                <NavLink to="/addproduct" className="btn btn-outline-light m-2">
                  <i className="fa fa-solid fa-plus"></i> Add Product
                </NavLink>
                <NavLink
                  to="/placedorders"
                  className="btn btn-outline-light m-2"
                >
                  <i class="fa-solid fa-pen-to-square"></i> All Orders Details
                </NavLink>
              </span>
            ) : (
              <></>
            ...
            {!(user?.role === Role.USER) ? (
              ...
              <>
                ...
                <NavLink to="/myorders" className="btn btn-outline-light m-2">
                  <i className="fa fa-cart-shopping mr-1"></i> My Orders{" "}
                </NavLink>
              </>
            )}
